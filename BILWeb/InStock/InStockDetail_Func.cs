...
namespace BILWeb.InStock
{
    public partial class T_InStockDetail_Func : TBase_Func<T_InStockDetail_DB, T_InStockDetailInfo>, IInStockDetailService
    {
        ...
        T_InStockDetail_DB _db = new T_InStockDetail_DB();

        protected override bool CheckModelBeforeSave(T_InStockDetailInfo model, ref string strError)
        {
            if (model == null)
            {
        ...
        /// <returns></returns>
        protected override bool CheckModelBeforeSave(List<T_InStockDetailInfo> modelList, ref string strError)
        {
        ...
        /// <returns></returns>
        private bool CheckScanQty(List<T_InStockDetailInfo> modelList, ref string strErrMsg)
        {
            bool bSucc = false;
        ...
        private int GetIsQualityByVoucherType(T_InStockDetailInfo model)
        {
            int iIsQuality = 0;
